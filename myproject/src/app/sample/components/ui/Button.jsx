...
const CustomButton = ({ children, href, onClick, className = "", ...props }) => {
  const baseClasses = "group relative inline-block bg-gradient-to-r from-blue-900 to-blue-600 hover:from-blue-700 hover:to-blue-700 text-white rounded-xl px-6 py-3 text-lg font-bold shadow-xl hover:shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 ease-in-out hover:scale-105 hover:-translate-y-1 focus:outline-none active:outline-none cursor-pointer text-center no-underline border border-purple-500/30 backdrop-blur-sm overflow-hidden";
