...
const Skills = ({ skills }) => {
    return(
        <section id="skills" className="bg-gradient-to-b from-purple-900/45 to-purple-900/20 py-20 px-4 md:px-20  scroll-mt-52">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
                ...
                <div
                    key={index}
                    className="bg-gray-950 hover:border-purple-500 border border-gray-700 rounded-xl p-8 flex flex-col items-center justify-center transition-all duration-300"
                >
